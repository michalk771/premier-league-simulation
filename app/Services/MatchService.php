...
class MatchService
{
    ...
    protected function applyStrengthModifiers(Team $homeTeam, Team $awayTeam, int &$homeScore, int &$awayScore): void
    {
    ...
    protected function updateLeagueTable(Team $homeTeam, Team $awayTeam, int $homeScore, int $awayScore): void
    {
    ...
    protected function updateTeamStats(League $team, int $goalsFor, int $goalsAgainst): void
    {
        $team->played++;
